    ...
    return(
        <div>
            <Typography component={'div'} variant="b1" align="left" color="text.secondary" style={{paddingLeft: 210, width: 975}} paragraph>
                ...
                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/4/44/University_of_California%2C_San_Diego_seal.svg/1200px-University_of_California%2C_San_Diego_seal.svg.png" alt="UCSD" align="right" width="100" height="100"/>
                </a>
                ...
                <a href="https://www.daybreakgames.com/home" target="_blank" rel="noopener noreferrer">
                <img src="https://upload.wikimedia.org/wikipedia/en/3/3e/Daybreak_Game_Company_logo.jpg" alt="Daybreak" align="right" width="100" height="70"/>
                </a>
                ...
                <a href="https://www.peraton.com/ready/" target="_blank" rel="noopener noreferrer">
                <img src="https://cms.jibecdn.com/prod/perspecta/assets/OPENGRAPH-IMAGE-en-us-1592581242933.png" alt="Perspecta" align="right" width="105" height="95"/>
                </a>
                ...
                <img src="https://images-na.ssl-images-amazon.com/images/G/01/gc/designs/livepreview/amazon_dkblue_noto_email_v2016_us-main._CB468775337_.png" alt="Amazon" align="right" width="90" height="60"/>
                </a>
        ...
        <div className="media">
            <ImageList sx={{ width: 300, height: 300 }} cols={1} rowHeight={30}>
                {itemData.map((item) => (
